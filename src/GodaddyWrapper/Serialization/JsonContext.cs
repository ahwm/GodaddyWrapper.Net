...
namespace GodaddyWrapper.Serialization
{
    ...
    //Requests (Domains v3)
    [JsonSerializable(typeof(DomainAvailableV3))]
    [JsonSerializable(typeof(DomainSuggestV3))]
    [JsonSerializable(typeof(RegistrationQuoteCreate))]
    [JsonSerializable(typeof(DomainRegistrationCreate))]
    [JsonSerializable(typeof(RegistrationConsent))]
    [JsonSerializable(typeof(DNSRecordV3))]
    [JsonSerializable(typeof(List<DNSRecordV3>))]
    [JsonSerializable(typeof(DNSRecordRetrieveV3))]
    ...
    //Responses (Domains v3)
    [JsonSerializable(typeof(SimpleMoneyResponse))]
    [JsonSerializable(typeof(TermPriceResponse))]
    [JsonSerializable(typeof(LinkResponse))]
    [JsonSerializable(typeof(ErrorDetailResponse))]
    [JsonSerializable(typeof(DomainV3ErrorResponse))]
    [JsonSerializable(typeof(DomainAvailableV3Response))]
    [JsonSerializable(typeof(SuggestionResponse))]
    [JsonSerializable(typeof(DomainSuggestionsV3Response))]
    [JsonSerializable(typeof(RequiredAgreementResponse))]
    [JsonSerializable(typeof(ResolvedSettingsResponse))]
    [JsonSerializable(typeof(RegistrationQuoteResponse))]
    [JsonSerializable(typeof(ConsentResponse))]
    [JsonSerializable(typeof(DomainRegistrationResponse))]
    [JsonSerializable(typeof(DomainDetailV3Response))]
    [JsonSerializable(typeof(DNSRecordResponseV3))]
    [JsonSerializable(typeof(List<DNSRecordResponseV3>))]
    [JsonSerializable(typeof(DNSRecordPageResponse))]
    [JsonSerializable(typeof(DomainOperationResultResponse))]
    [JsonSerializable(typeof(DomainOperationResponse))]
